# 25: Rules Rendering for Humans (Web UI + Email) - Design

> Extracted 2026-07-08 from `docs/plan/25-rules-rendering.md` (superpowers layout
...
`docs/superpowers/plans/2026-07-05-22-email-via-resend.md`), so it must come after 22b lands.
...
- **Invite/notification emails** (22, `docs/superpowers/specs/2026-07-04-24-game-invites-design.md`) get a
