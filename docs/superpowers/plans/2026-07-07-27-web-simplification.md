# 27: rust/web simplification (skinny queries, dedup, client plumbing) - Implementation Plan
...
>
> Extracted 2026-07-08 from `docs/plan/27-web-simplification.md`. Task granularity is
...
**Spec:** `docs/superpowers/specs/2026-07-07-27-web-simplification-design.md`
...
Read `docs/superpowers/specs/2026-07-05-17-nats-migration-ws-simplification-design.md` "Client-side
