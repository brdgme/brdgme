...
- [ ] **Step 1: Ask the user to run against prod:**
...
- [ ] **Step 3: Verify nothing else broke at runtime** (the `SELECT * FROM
...
- [ ] **Step 1: Write the failing tests** (add to `mod tests` in db.rs,
...
- [ ] **Step 3: Implement** (in db.rs, after `set_user_theme`; every fn
