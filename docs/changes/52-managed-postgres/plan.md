...
# docs/changes/52-managed-postgres/spec.md). Replaces the
...
Mark `docs/changes/52-managed-postgres/spec.md` Status as complete with the date.

```bash
git add docs/changes/52-managed-postgres/spec.md
