...
this item. See docs/changes/archive/2026-07-08-16-production-cutover-validation/plan.md "Beta
period".

**Spec:** `docs/changes/archive/2026-07-06-21-opentofu-iac/spec.md`
...
- [ ] Cutover hostname records (revised 2026-07-05 to match the Phase 16
      ...
      controller plan, see docs/changes/archive/2026-07-08-20-external-dns-spec/spec.md): at beta start,
