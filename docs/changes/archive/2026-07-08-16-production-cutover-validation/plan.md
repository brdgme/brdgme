...
**Spec:** `docs/changes/archive/2026-07-08-16-production-cutover-validation/spec.md`
...
- [ ] **Superseded 2026-07-08 (do not do):** the break-glass overlay below.
      ...
      See [31-rust-only-repo.md](../../31-rust-only-repo/spec.md).
...
- [ ] **Superseded 2026-07-08 (do not do):** the Cilium PROXY-protocol flip
      ...
      docs/changes/archive/2026-07-05-14-drop-knative-gateway-api/plan.md
      (prod-prerequisites section) for full detail, and
      docs/changes/archive/2026-07-08-28-abuse-protection/spec.md for
...
- [ ] ~~Enable PROXY protocol on the Cilium side FIRST~~ *(human)*. Wrong
      ...
      docs/changes/archive/2026-07-05-14-drop-knative-gateway-api/plan.md prod-prerequisites section.
