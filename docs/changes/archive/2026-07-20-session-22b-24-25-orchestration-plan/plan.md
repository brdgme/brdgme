...
- #22: `docs/changes/archive/2026-07-05-22-email-via-resend/spec.md`
- #24: `docs/changes/archive/2026-07-04-24-game-invites/spec.md`
- #25: `docs/changes/archive/2026-07-05-25-rules-rendering/spec.md`
- #26 theming (done): `docs/changes/archive/2026-07-05-26-theming/spec.md`,
...
### Survey Leads (write context-handover docs at docs/changes/<active-change>/handover.md)
- S1 #22 email survey -> the deleted #22 email survey handover (temporary session doc)
- S2 #25 rules/strategy survey -> the deleted #25 rules/strategy survey handover (temporary session doc)
- S3 #24 invites survey -> the deleted #24 invites survey handover (temporary session doc)
...
8. **#22 survey resolutions** (from the deleted #22 email survey handover, a temporary session doc):
...
14. **#25 survey resolutions** (from the deleted #25 rules/strategy survey handover, a temporary session doc):
...
21. **#24 survey resolutions** (from the deleted #24 invites survey handover, a temporary session doc):
