...
**Spec:** `docs/changes/archive/2026-07-09-deterministic-game-rng/spec.md`
...
- Delete: the deleted superseded `zombie-dice-test-determinism` plan
...
- [ ] **Step 3:** Delete the deleted superseded `zombie-dice-test-determinism` plan (the design spec records why).
