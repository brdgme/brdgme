...
- Findings aggregate into
  `docs/changes/archive/2026-07-11-render-parity-audit-findings-plan/plan.md`.
...
- [ ] Write `docs/changes/archive/2026-07-11-render-parity-audit-findings-plan/plan.md`
