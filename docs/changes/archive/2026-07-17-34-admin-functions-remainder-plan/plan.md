...
**Spec:** `docs/changes/archive/2026-07-11-34-admin-functions-spec/spec.md` (D3, D4, D5; D1/D2 patterns already exist - follow `bump_bot_turns` in `rust/web/src/game/server_fns.rs:679` and the admin-gated `<Show>` in `rust/web/src/components/game.rs:124`).
