...
**Spec:** `docs/changes/archive/2026-07-19-new-game-page/spec.md`. The companion preview spec (`2026-07-19-new-game-preview-design.md`) is OUT of scope for this plan.
...
//! Spec: docs/changes/archive/2026-07-19-new-game-page/spec.md
