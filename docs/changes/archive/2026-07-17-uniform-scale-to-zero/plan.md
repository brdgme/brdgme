...
**Spec:** docs/changes/archive/2026-07-17-uniform-scale-to-zero/spec.md
...
**Files:**
- Modify: `docs/changes/archive/2026-07-17-uniform-scale-to-zero/plan.md` (record evidence)
...
```bash
git add docs/changes/archive/2026-07-17-uniform-scale-to-zero/plan.md
