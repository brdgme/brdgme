...
fn sentry_init_snippet(dsn: &str, release: Option<&str>) -> String {
    ...
    // directly). See docs/changes/archive/2026-07-21-sentry-performance-tracing/spec.md.
    format!(
...
Update the Status line of `docs/changes/archive/2026-07-21-sentry-performance-tracing/spec.md` to note Phase 1 + Sentry-side config complete with the date.

- [ ] **Step 5: Commit the status update**

```bash
git add docs/changes/archive/2026-07-21-sentry-performance-tracing/spec.md
