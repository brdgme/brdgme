...
`docs/changes/archive/2026-07-05-22-email-via-resend/plan.md`), so it must come after 22b lands.
...
- **Invite/notification emails** (22, `docs/changes/archive/2026-07-04-24-game-invites/spec.md`) get a
