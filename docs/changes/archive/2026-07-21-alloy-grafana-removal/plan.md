...
/// (docs/changes/archive/2026-07-21-alloy-grafana-removal/spec.md).
#[cfg(feature = "ssr")]
fn init_tracing() {
...
Mark `docs/changes/archive/2026-07-21-alloy-grafana-removal/spec.md` Status as complete with the date.

```bash
git add docs/changes/archive/2026-07-21-alloy-grafana-removal/spec.md
