...
| R-49 | in-progress | | scope: R49.1 F-01/F-02/F-04; R49.2 F-03/F-08. F-07 REFUTED under the current trusted no-thanks-2 contract (pub_state derives Some(peek_top_card()); Game has no current_card field to validate); no response-validation layer, render fallback, no-thanks change, or new contract; hostile/mismatched service-response validation needs separately approved scope. Deliberate impl Parser for CommandSpec preserved (mod.rs:878; COMMAND_PARSER_SPEC_DEDUP.md). |
