...
| R-42 | in-progress | | U42.1..U42.5 approved; F-15 remains latent and parked for later review because a local equality test cannot enforce future renderer output. |
| R-43 | pending | | |
| R-44 | blocked(5.2) | | |
