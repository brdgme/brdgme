...
- Phase 11.6 (frontend/page testing) - redesigned 2026-07-04 into 11.6a
  (in-process SSR page tests) + 11.6b (minimal hydration smoke); now fully
  specified and delegable as one task - see the section for the remaining
  checklist and the uncommitted working-tree state it builds on.
...
working implementation was built (see "Current uncommitted state" below)
...
**Current uncommitted state (as of 2026-07-04, working tree on `leptos`):**
all of the following exists uncommitted and should be the starting point,
not rebuilt:
...
## Phase 23: Rust Game Ports [Pending]
