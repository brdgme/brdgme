...
# Rust games
for game in ["acquire-1", "battleship-2", "category-5-2", "farkle-2", "for-sale-2", "greed-2", "liars-dice-2", "lost-cities-1", "lost-cities-2", "no-thanks-2", "sushi-go-2", "sushizock-2", "zombie-dice-2"]:
